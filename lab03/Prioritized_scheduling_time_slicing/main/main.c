/*
* creator/date: Group-06/Oct.11.2023
...
void Jack_is_coming(void* pvParameter){
    printf("\n********************************\n");
    printf("* At %ld ms, Jack come and snatched the mic\n", pdTICKS_TO_MS(xTaskGetTickCount()));
...
void app_main(void) {
    ...
    xTaskCreatePinnedToCore(Jack_is_coming,"Task3",5120, NULL, 5,NULL,0); //
}

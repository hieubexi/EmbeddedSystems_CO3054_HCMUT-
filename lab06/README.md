...
| ----------------- | ----- | -------- | -------- | -------- | -------- | -------- | -------- |
# About this program
In this program, we use ESP32 as a station role, and implement simple web server.<br>
Please note that, you need to config "your wifi id" and "your wifi password" to run this program.
# Folder contents
The project **lab06** contains one source file in C language [main.c](main/main.c).
